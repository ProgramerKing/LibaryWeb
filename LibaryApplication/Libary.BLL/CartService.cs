...
namespace Libary.BLL
{
	...
	{
		private readonly  CartDAL dal=new CartDAL();
		public CartService()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cart GetModelByCache(int Id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cart> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cart> DataTableToList(DataTable dt)
		{
