...
namespace Libary.BLL
{
    ...
    /// RoleActionInfo
    /// </summary>
    public partial class RoleActionInfoService
    {
		private readonly  RoleActionInfoDAL dal=new RoleActionInfoDAL();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public  RoleActionInfo GetModelByCache(int Role_ID,int ActionInfo_ID)
		{
			...
			return ( RoleActionInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List< RoleActionInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List< RoleActionInfo> DataTableToList(DataTable dt)
		{
			List< RoleActionInfo> modelList = new List< RoleActionInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				 RoleActionInfo model;
