...
namespace Libary.BLL
{
    ...
    public partial class SysFunService
    {
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public  SysFun GetModelByCache(int NodeId)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List< SysFun> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List< SysFun> DataTableToList(DataTable dt)
		{
			List< SysFun> modelList = new List< SysFun>();
