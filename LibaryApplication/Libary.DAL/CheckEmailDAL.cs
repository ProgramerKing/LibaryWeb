...
namespace Libary.DAL
{
    ...
    public partial class CheckEmailDAL
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(CheckEmail model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into CheckEmail(");
            strSql.Append("Actived,ActiveCode)");
            strSql.Append(" values (");
            strSql.Append("SQL2012Actived,SQL2012ActiveCode)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Actived", SqlDbType.Bit,1),
                    new SqlParameter("SQL2012ActiveCode", SqlDbType.NVarChar,50)};
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(CheckEmail model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CheckEmail set ");
            strSql.Append("Actived=SQL2012Actived,");
            strSql.Append("ActiveCode=SQL2012ActiveCode");
            strSql.Append(" where Id=SQL2012Id");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Actived", SqlDbType.Bit,1),
                    new SqlParameter("SQL2012ActiveCode", SqlDbType.NVarChar,50),
        ...
        /// 得到一个对象实体
        /// </summary>
        public CheckEmail GetModel(int Id)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public CheckEmail DataRowToModel(DataRow row)
        {
            CheckEmail model = new CheckEmail();
            if (row != null)
            {
