...
namespace Libary.DAL
{
    ...
    public partial class RoleDepartmentDAL
    {
        ...
        public bool Exists(int Role_ID, int Department_ID)
        {
            ...
            strSql.Append(" where Role_ID=SQL2012Role_ID and Department_ID=SQL2012Department_ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Role_ID", SqlDbType.Int,4),
                    new SqlParameter("SQL2012Department_ID", SqlDbType.Int,4)           };
        ...
        public bool Add(RoleDepartment model)
        {
            ...
            strSql.Append("SQL2012Role_ID,SQL2012Department_ID)");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Role_ID", SqlDbType.Int,4),
                    new SqlParameter("SQL2012Department_ID", SqlDbType.Int,4)};
...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
            ...
            strSql.Append("Department_ID=SQL2012Department_ID");
            strSql.Append(" where Role_ID=SQL2012Role_ID and Department_ID=SQL2012Department_ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Role_ID", SqlDbType.Int,4),
                    new SqlParameter("SQL2012Department_ID", SqlDbType.Int,4)};
        ...
        public RoleDepartment GetModel(int Role_ID, int Department_ID)
        {
            ...
            RoleDepartment model = new RoleDepartment();
        ...
        /// 得到一个对象实体
        /// </summary>
        public RoleDepartment DataRowToModel(DataRow row)
        {
            RoleDepartment model = new RoleDepartment();
            if (row != null)
            {
