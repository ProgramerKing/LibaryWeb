...
namespace Libary.DAL
{
    ...
    public partial class BooksDAL
    {
        ...
        public int Add(Books model)
        {
            ...
            strSql.Append("SQL2012Title,SQL2012Author,SQL2012PublisherId,SQL2012PublishDate,SQL2012ISBN,SQL2012WordsCount,SQL2012UnitPrice,SQL2012ContentDescription,SQL2012AurhorDescription,SQL2012EditorComment,SQL2012TOC,SQL2012CategoryId,SQL2012Clicks)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Title", SqlDbType.NVarChar,200),
                    new SqlParameter("SQL2012Author", SqlDbType.NVarChar,200),
                    new SqlParameter("SQL2012PublisherId", SqlDbType.Int,4),
                    new SqlParameter("SQL2012PublishDate", SqlDbType.DateTime),
                    new SqlParameter("SQL2012ISBN", SqlDbType.NVarChar,50),
                    new SqlParameter("SQL2012WordsCount", SqlDbType.Int,4),
                    new SqlParameter("SQL2012UnitPrice", SqlDbType.Money,8),
                    new SqlParameter("SQL2012ContentDescription", SqlDbType.NVarChar,-1),
                    new SqlParameter("SQL2012AurhorDescription", SqlDbType.NVarChar,-1),
                    new SqlParameter("SQL2012EditorComment", SqlDbType.NVarChar,-1),
                    new SqlParameter("SQL2012TOC", SqlDbType.NVarChar,-1),
                    new SqlParameter("SQL2012CategoryId", SqlDbType.Int,4),
                    new SqlParameter("SQL2012Clicks", SqlDbType.Int,4)};
        ...
        public bool Update(Books model)
        {
            ...
            strSql.Append("Author=SQL2012Author,");
            strSql.Append("PublisherId=SQL2012PublisherId,");
            strSql.Append("PublishDate=SQL2012PublishDate,");
            strSql.Append("ISBN=SQL2012ISBN,");
            strSql.Append("WordsCount=SQL2012WordsCount,");
            strSql.Append("UnitPrice=SQL2012UnitPrice,");
            strSql.Append("ContentDescription=SQL2012ContentDescription,");
            strSql.Append("AurhorDescription=SQL2012AurhorDescription,");
            strSql.Append("EditorComment=SQL2012EditorComment,");
            strSql.Append("TOC=SQL2012TOC,");
            strSql.Append("CategoryId=SQL2012CategoryId,");
            strSql.Append("Clicks=SQL2012Clicks");
            strSql.Append(" where Id=SQL2012Id");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Title", SqlDbType.NVarChar,200),
                    new SqlParameter("SQL2012Author", SqlDbType.NVarChar,200),
        ...
        /// 得到一个对象实体
        /// </summary>
        public Books DataRowToModel(DataRow row)
        {
            Books model = new Books();
            if (row != null)
            {
