...
namespace Libary.DAL
{
    ...
    public partial class SearchDetailsDAL
    {
        ...
        public bool Add(SearchDetails model)
        {
            ...
            strSql.Append("SQL2012Id,SQL2012KeyWords,SQL2012SearchDateTime)");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Id", SqlDbType.UniqueIdentifier,16),
                    new SqlParameter("SQL2012KeyWords", SqlDbType.NVarChar,255),
                    new SqlParameter("SQL2012SearchDateTime", SqlDbType.DateTime)};
        ...
        public bool Update(SearchDetails model)
        {
            ...
            strSql.Append("SearchDateTime=SQL2012SearchDateTime");
            strSql.Append(" where Id=SQL2012Id ");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012KeyWords", SqlDbType.NVarChar,255),
                    new SqlParameter("SQL2012SearchDateTime", SqlDbType.DateTime),
        ...
        /// 得到一个对象实体
        /// </summary>
        public SearchDetails DataRowToModel(DataRow row)
        {
            SearchDetails model = new SearchDetails();
            if (row != null)
            {
