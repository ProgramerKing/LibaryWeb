...
namespace Libary.DAL
{
	...
	/// 数据访问类:ActionGroup
	/// </summary>
	public partial class ActionGroupDAL
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ActionGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ActionGroup(");
			strSql.Append("GroupName,GroupType,DelFlag,Sort)");
			strSql.Append(" values (");
			strSql.Append("SQL2012GroupName,SQL2012GroupType,SQL2012DelFlag,SQL2012Sort)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012GroupName", SqlDbType.NVarChar,32),
					new SqlParameter("SQL2012GroupType", SqlDbType.SmallInt,2),
					new SqlParameter("SQL2012DelFlag", SqlDbType.NVarChar,-1),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update( ActionGroup model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ActionGroup set ");
			strSql.Append("GroupName=SQL2012GroupName,");
			strSql.Append("GroupType=SQL2012GroupType,");
			strSql.Append("DelFlag=SQL2012DelFlag,");
			strSql.Append("Sort=SQL2012Sort");
			strSql.Append(" where ID=SQL2012ID");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012GroupName", SqlDbType.NVarChar,32),
					new SqlParameter("SQL2012GroupType", SqlDbType.SmallInt,2),
		...
		/// 得到一个对象实体
		/// </summary>
		public  ActionGroup GetModel(int ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public  ActionGroup DataRowToModel(DataRow row)
		{
			 ActionGroup model=new  ActionGroup();
			if (row != null)
			{
