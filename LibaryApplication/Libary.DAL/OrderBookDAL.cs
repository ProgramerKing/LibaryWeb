...
namespace Libary.DAL
{
    ...
    public partial class OrderBookDAL
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(OrderBook model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into OrderBook(");
            strSql.Append("OrderID,BookID,Quantity,UnitPrice)");
            strSql.Append(" values (");
            strSql.Append("SQL2012OrderID,SQL2012BookID,SQL2012Quantity,SQL2012UnitPrice)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012OrderID", SqlDbType.NVarChar,50),
                    new SqlParameter("SQL2012BookID", SqlDbType.Int,4),
                    new SqlParameter("SQL2012Quantity", SqlDbType.Int,4),
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(OrderBook model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update OrderBook set ");
            strSql.Append("OrderID=SQL2012OrderID,");
        ...
        /// 得到一个对象实体
        /// </summary>
        public OrderBook GetModel(int Id)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public OrderBook DataRowToModel(DataRow row)
        {
            OrderBook model = new OrderBook();
            if (row != null)
            {
