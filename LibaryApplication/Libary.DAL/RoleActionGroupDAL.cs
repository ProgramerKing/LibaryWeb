...
namespace Libary.DAL
{
    ...
    /// </summary>
    public partial class RoleActionGroupDAL
    {
        ...
        public bool Exists(int Role_ID, int ActionGroup_ID)
        {
            ...
            strSql.Append(" where Role_ID=SQL2012Role_ID and ActionGroup_ID=SQL2012ActionGroup_ID ");
        ...
        public bool Add(RoleActionGroup model)
        {
            ...
            strSql.Append("SQL2012Role_ID,SQL2012ActionGroup_ID)");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012Role_ID", SqlDbType.Int,4),
                    new SqlParameter("SQL2012ActionGroup_ID", SqlDbType.Int,4)};
...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
        ...
        public RoleActionGroup GetModel(int Role_ID, int ActionGroup_ID)
        {
            ...
            RoleActionGroup model = new RoleActionGroup();
        ...
        /// 得到一个对象实体
        /// </summary>
        public RoleActionGroup DataRowToModel(DataRow row)
        {
            RoleActionGroup model = new RoleActionGroup();
            if (row != null)
            {
