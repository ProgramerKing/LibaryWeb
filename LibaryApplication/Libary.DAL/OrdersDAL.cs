...
namespace Libary.DAL
{
    ...
    public partial class OrdersDAL
    {
        ...
        public bool Add(Orders model)
        {
            ...
            strSql.Append("SQL2012OrderId,SQL2012OrderDate,SQL2012UserId,SQL2012TotalPrice,SQL2012PostAddress,SQL2012state)");
            SqlParameter[] parameters = {
                    new SqlParameter("SQL2012OrderId", SqlDbType.NVarChar,50),
                    ...
                    new SqlParameter("SQL2012PostAddress", SqlDbType.NVarChar,255),
        ...
        public bool Update(Orders model)
        {
            ...
            strSql.Append("PostAddress=SQL2012PostAddress,");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Orders DataRowToModel(DataRow row)
        {
            Orders model = new Orders();
            if (row != null)
            {
